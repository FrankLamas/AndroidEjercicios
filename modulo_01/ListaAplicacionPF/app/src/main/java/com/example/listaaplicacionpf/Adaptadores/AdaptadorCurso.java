package com.example.listaaplicacionpf.Adaptadores;
...
import com.example.listaaplicacionpf.R;
import com.example.listaaplicacionpf.TomarListaAct;
import com.example.listaaplicacionpf.listener.OnItemListenerProyecto;
...
public class AdaptadorCurso  extends RecyclerView.Adapter<AdaptadorCurso.ViewHolderCursos> implements  OnItemListenerProyecto{
    ...
    public void onItemClick(View v, int posicion) {
        Intent i = new Intent(context, TomarListaAct.class);
    ...
    public static class ViewHolderCursos extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public ViewHolderCursos(@NonNull View itemView, OnItemListenerProyecto listener) {
            ...
            txtNombreCurso = (TextView) itemView.findViewById(R.id.nombreCurso);
            txtPorcentajeCurso = (TextView) itemView.findViewById(R.id.porcentajeCurso);
